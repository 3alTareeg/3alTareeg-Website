...
import NavBar from "../OsaidComponents/NavBar";
import { BrowserRouter as Router, Route, Switch, Link } from "react-router-dom";
import NoAccessCompanies from "../OsaidComponents/NoAccessCompanies";
...
export default class Checkout extends Component {
  ...
  render() {
    ...
    if (localStorage.logedIn === "false") return <NoAccessCompanies />;
      ...
      return (
        <>
          <NavBar info={this.props.location.state.info} logOut={this.logOut} />
          <div class="Far">
